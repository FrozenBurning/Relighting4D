...
from . import utils
from .nielsen2015on import merlFunctions as merl
from .nielsen2015on import coordinateFunctions as coord
...
class MERL:
    ...
    def characteristic_slice_as_img(cslice, clip_percentile=80):
        ...
        cslice_uint = utils.linalg.denormalize_float(cslice_0to1)
        cslice_img = utils.camera.gamma_correct(cslice_uint)
        return cslice_img
